...
public class Bank {
	...
	public void run() {
		...
		savingsAccount.deposit(amount); //deposit into checking account
		...
		//from checking
		System.out.println(); //blank line
		System.out.println("Amount (decimal) to withdraw from our checking account?");
		amount = scanner.nextDouble(); //get next token (double)
		...
		//from savings
		System.out.println(); //blank line
		System.out.println("Amount (decimal) to withdraw from our savings account?");
		amount = scanner.nextDouble(); //get next token (double)
